...
* Dependency on [metalsmith-prismic-server](https://github.com/futurice/metalsmith-prismic-server)
...
* [Prismic.io example content](https://metalsmith-prismic-template.prismic.io/)
  ...
  * [Published content also running in Heroku](https://metalsmith-prismic.herokuapp.com/builds/master/)
...
* Run `npm install`
* Copy `.env.tmpl` and rename to `.env`
...
* Set up a Prismic.io
  ...
  * Setup webhooks in Prismic settings
    ...
    * Secret: {GENERATE_YOUR_WEBHOOK_SECRET}
  * Add tokens to `.env`
